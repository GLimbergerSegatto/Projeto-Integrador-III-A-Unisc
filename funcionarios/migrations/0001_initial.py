    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funcao', models.CharField(blank=True, choices=[('ACG', 'Açougueiro'), ('LIM', 'Encarregado de limpeza'), ('REP', 'Repositor'), ('CAX', 'Operador do Caixa'), ('EMP', 'Empacotador'), ('ADM', 'Administrador'), ('PAD', 'Padeiro')], max_length=3, null=True)),
